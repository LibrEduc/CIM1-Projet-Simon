/* Ce programme est légèrement différent du programme tinkercad n°17:
 *  Les numéros des broches utilisés ont été mis à jour.
 *  La fréquence des led NeoPixel a été adapté pour fonctionner avec celle réellement utilisé
*/

#define buzzerPin 2 // Le buzzer est connecté à la broche n°8
...
#define NeoPixelPin 8 // Broche sur laquelle les NeoPixels sont connectées
#define PixelCount 4 // Nombre de NeoPixel
Adafruit_NeoPixel MyLed = Adafruit_NeoPixel(PixelCount, NeoPixelPin, NEO_GRB + NEO_KHZ400); // Affectation des paramètres définies ci-dessus.
